...
const Section = ({ isLoading, error, data }) => {
    ...
    return (
        <>
            ...
            <div className={` h-fit z-[201] md:z-[0] bg-white md:bg-transparent rounded-l-lg fixed ${isWidget ? "translate-x-0" : "translate-x-[100%]"} md:translate-x-0  md:translate-y-0 right-0 md:static max-w-[75%] sm:max-w-[60%] md:w-[20%] md:min-w-[20%] flex flex-col gap-8 py-6 md:py-2 p-2 transition-all ease-in-out duration-500`}>
