        ...
        <div className="flex flex-col w-full h-full bg-white">
            <div className=" relative flex flex-col gap-2 items-center justify-center w-full h-[50%] bg-gradient-to-b from-transparent via-blue-200 to-blue-400">
                ...
                <div className="flex w-full flex-col items-center">
                    <h1 className=" font-semibold text-xl">Mrunal Vaidya</h1>
                    <p className=" text-sm text-gray-700">Member since <span className=' text-black'>{formatDistanceToNow(new Date())}</span></p>
                </div>
